        ...
        <div className="py-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-6 text-sm leading-relaxed">
              India's premier platform connecting professional drivers with passengers.
              Join our growing community of driver partners across the nation.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {["About Us", "How It Works", "Driver Requirements", "Fleet Owners", "Careers", "Press"].map((item) => (
                <li key={item}>
                  <Link href={`/${item.toLowerCase().replace(/\s+/g, '-')}`} className="group flex items-center text-gray-600 hover:text-blue-600 transition duration-150">
                    <ChevronRightIcon className="h-4 w-4 mr-2 text-gray-400 group-hover:text-blue-500" />
                    <span>{item}</span>
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-3">
              {["Help Center", "Safety Center", "Community Guidelines", "FAQs", "Contact Us", "Legal"].map((item) => (
                <li key={item}>
                  <Link href={`/${item.toLowerCase().replace(/\s+/g, '-')}`} className="group flex items-center text-gray-600 hover:text-blue-600 transition duration-150">
                    <ChevronRightIcon className="h-4 w-4 mr-2 text-gray-400 group-hover:text-blue-500" />
                    <span>{item}</span>
            ...
            <ul className="space-y-4">
              <li>
                <a href="tel:+911234567890" className="flex items-start text-gray-600 hover:text-blue-600 transition duration-150">
                  <PhoneIcon className="h-5 w-5 mr-3 text-blue-500 flex-shrink-0" />
              ...
              <li>
                <a href="mailto:support@bharatsarthi.com" className="flex items-start text-gray-600 hover:text-blue-600 transition duration-150">
                  <EnvelopeIcon className="h-5 w-5 mr-3 text-blue-500 flex-shrink-0" />
                  <span>support@bharatsarthi.com</span>
                </a>
              </li>
              <li className="flex items-start text-gray-600">
                <MapPinIcon className="h-5 w-5 mr-3 text-blue-500 flex-shrink-0 mt-0.5" />
                <span>123 Sarthi Marg,<br />New Delhi, 110001,<br />India</span>
              </li>
            </ul>
            
            {/* App Download */}
            <div className="mt-6">
              <h4 className="text-sm font-medium text-gray-700 mb-3">Download Our App</h4>
